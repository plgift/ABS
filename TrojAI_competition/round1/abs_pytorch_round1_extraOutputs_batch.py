...
def main(model_filepath, result_filepath, scratch_dirpath, examples_dirpath, modelName, ExperimentName, example_img_format='png',):
    with open("/home/nnichols/Documents/Projects/trojai/ABS/TrojAI_competition/round1/denseResNetModelNames50.txt") as f
        ...
        for i in modelnums:
            abs_pytorch_round1_extraOutputs(--model_filepath '/mnt/nfs/ml-shared/trojai_data/dl/round1train/models/'+i+'/model.pt' --result_filepath  '/mnt/nfs/ml-shared/trojai_data/ABS/TAI_round1_abs/'  --scratch_dirpath '/mnt/nfs/ml-shared/trojai_data/ABS/TAI_round1_abs/'   --examples_dirpath '/mnt/nfs/ml-shared/trojai_data/dl/round1train/models/'+i+'/example_data/'  --modelName i  --ExperimentName 'debugPTtest1')
